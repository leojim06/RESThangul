...
var JamoSchema = new mongoose_1.Schema({
    jamo: {
        type: String,
        trim: true,
        unique: true,
...
JamoSchema.statics = {
    ...
    getGruposConsonanticos: function (query) {
        var result = this.find({
...
exports.default = mongoose_1.model('Jamo', JamoSchema);
// 'Vocal', 'Vocal Doble',
// 'Consonante', 'Consonante Derivada', 'Consonante Doble',
// 'Grupo Consonantico' 
